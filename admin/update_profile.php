                      ...
                      <div class="card-body">
                        <form class="form-horizontal">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="password" name="password" class="form-control"><small class="help-block-none">Votre mot de passe actuel.</small>
                            </div>
                          </div>
                          <div class="line"></div>
                          <div class="form-group row">
                              <label class="col-sm-3 form-control-label">Mot de passe</label>
                              <div class="col-sm-9">
                                <input type="password" name="password" class="form-control"><small class="help-block-none">Nouveau mot de passe.</small>
                              </div>
                            </div>
                          <div class="line"></div>
                          <div class="form-group row">
